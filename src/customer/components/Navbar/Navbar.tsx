                    ...
                    <div className='flex items-center gap-9'>
                        ...
                        <ul className='flex items-center font-medium text-gray-800'>
                                ...
                                className='mainCategory
                                 hover:text-primary-color hover:border-b-2 h-[70px] px-4
                    ...
                    <div className='flex gap-1 lg:gap-6 items-center'>
                        ...
                        </IconButton>
                        {
                            true ? <Button className='flex items-center gap-2'>
                                ...
                                src='https://images.pexels.com/photos/1214205/pexels-photo-1214205.jpeg'/>
                                <h1 className='font-semibold hidded lg:block'>
                                    Harsa
                                    </h1>
